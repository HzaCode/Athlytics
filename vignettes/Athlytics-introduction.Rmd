...
You also need the `rStrava` package for authentication:
...
**Note:** Fetching decoupling data requires detailed activity streams and can be very slow and API-intensive.
