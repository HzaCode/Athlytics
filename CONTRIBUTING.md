...
1.  **Check for Existing Issues:** Before starting work on a new feature
    ...
    tab](https://github.com/HzaCode/Athlytics/issues) to see if someone
...
3.  **Fork the Repository:** Fork the [Athlytics
    repository](https://github.com/HzaCode/Athlytics) to your own GitHub
    account.
...
5.  **Make Your Changes:** Make your changes in your branch. Ensure that
    ...
    - Run
      ...
      locally to ensure your changes pass all checks.
