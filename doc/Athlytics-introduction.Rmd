...
1.  **Create a Strava API Application:**
    -   Go to your Strava settings page for API applications (you can usually find this via your profile settings or by searching Strava's developer documentation, the direct link was previously `https://www.strava.com/settings/api` but requires login).
